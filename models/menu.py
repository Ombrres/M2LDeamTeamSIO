...
response.menu += [('Nos ligues', False, URL('ctrl_ligue', 'index'), [])]
response.menu += [('Actualités sportives de la presse', False, URL('default', 'index'), [])]
response.menu += [('Intranet', False, URL('default', 'index'), 
                    [('Réservation de salles', False, URL('ctrl_salle', 'index'), [])
                    ])
                 ]
